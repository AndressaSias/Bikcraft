...
// Mudar Aqui o e-mail
$email_envio = 'contato@andressa.com.br'; // E-mail do site (ex: contato@seusite.com)
$email_pass = 'malonns2'; // Senha do e-mail

$site_name = 'Bikcraft'; // Nome do Site
$site_url = 'www.andressasias.com.br'; // URL do Site
